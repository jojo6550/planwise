...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="<?= BASE_URL ?>/index.php?page=teacher/dashboard">PlanWise</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <?php
                    $navItems = [
                        'dashboard'    => ['label' => 'Dashboard',    'url' => BASE_URL . '/index.php?page=teacher/dashboard'],
                        'lesson-plans' => ['label' => 'Lesson Plans', 'url' => BASE_URL . '/index.php?page=teacher/lesson-plans'],
                        'profile'      => ['label' => 'Profile',      'url' => BASE_URL . '/index.php?page=teacher/profile'],
                    ];
